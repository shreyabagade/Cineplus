...
public class movie extends javax.swing.JFrame {
 public movie() {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CINEPLUS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "GODFATHER","VIKRAM VEDHA", "BRAHMASTRA", "PS-1", "AVATAR", "RAM SETU","KANTARA","TICKET TO PARADISE","BLACK ADAM" }));

        jComboBox2.setFont(new java.awt.Font("Times New Roman", 1, 24)); 
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PVR", "IMAX", "MOVIETIME", "GALAXY","INOX" }));

        jComboBox3.setFont(new java.awt.Font("Times New Roman", 1, 24)); 
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "7:00AM","9:00 AM","11:30AM", "12:00PM","3:00PM", "6:00PM", "9:00PM" }));

        jComboBox4.setFont(new java.awt.Font("Times New Roman", 1, 24)); 
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "28-10-2022", "29-10-2022", "30-10-2022", "31-10-2022","01-11-2022","02-11-2022" }));
        ...
        jLabel3.setText("SELECT SHOW TIME:");
     ...
     public void workWithDatabase()
    {
      ...
      if(N2<10 && N2>0)
         ...
         {  
             this.setVisible(false);  new cardselection(a,b,e,d,N1,f).setVisible(true); 
